...
public class Gun : MonoBehaviour {
    ...
    private void Awake() {
        ...
        //오디오 플레이어와, Linelender getcomponent로 안찾아보자
    ...
    private IEnumerator ReloadRoutine() {
        ...
        //총알 충전
        int reroadedammo = ((gunData.magCapacity - magAmmo) <= ammoRemain) ? ((gunData.magCapacity - magAmmo)) : ammoRemain;
        magAmmo += reroadedammo;
        ammoRemain -= reroadedammo;
